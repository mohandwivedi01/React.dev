...
function Footer(){
    return(
        <footer className="bg-sky-900 border-y">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-100 sm:text-center">
                        © 2024- 
                        <a href="https://github.com/mohandwivedi01" className="hover:underline hover:text-orange-500">
                            mohan.dev
                        </a>
                        . All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        <Link to="#" className="text-gray-100 hover:text-orange-500">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
